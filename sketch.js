...
function setup() {
  createCanvas(300, 550); // Cambiar tamaño del canvas a 300 x 550
  Capafondo = createGraphics(300, 550); // Cambiar tamaño de la capa de fondo a 300 x 550
  Capafondo.image(fondo, 0, 0, 300, 550); // Dibujar la imagen de fondo en la capa con nuevo tamaño

  CapamanchaG = createGraphics(300, 550); // Cambiar tamaño de la capa de manchas G a 300 x 550
  CapamanchaN = createGraphics(300, 550); // Cambiar tamaño de la capa de manchas N a 300 x 550
  Capalineas = createGraphics(300, 550); // Cambiar tamaño de la capa de líneas a 300 x 550
}
...
function draw() {
  ...
  if (capaActual === "N") {
    ...
    manejarManchas(manchasLineas, Linea, lineas, 100, 150);
...
function actualizarCapa(tiempoTranscurrido) {
  ...
  if (mouseY > 0 && mouseY < 183) { // Ajustar límites de la capa N para el nuevo tamaño
    nuevaCapa = "N";
  } else if (mouseY > 366 && mouseY < 550) { // Ajustar límites de la capa L para el nuevo tamaño
    nuevaCapa = "L";
  } else if (mouseY > 183 && mouseY < 366) { // Ajustar límites de la capa G para el nuevo tamaño
    nuevaCapa = "G";
  }
